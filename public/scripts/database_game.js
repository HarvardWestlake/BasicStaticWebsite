class ClickBoxGame {
    constructor() {
        ...
        const firebaseConfig = {
            apiKey: "AIzaSyDIDpSys45D_4Do8VI7dzuizFNj6mAGC50",
            authDomain: "whateveryouwant-7eb26.firebaseapp.com",
            projectId: "whateveryouwant-7eb26",
            storageBucket: "whateveryouwant-7eb26.appspot.com",
            messagingSenderId: "928157929482",
            appId: "1:928157929482:web:050defae42763aeb558ff3",
            measurementId: "G-9G27DTXSGE"
          };
    ...
    handleClick(event) {
        ...
        if (x >= this.boxX && x <= this.boxX + this.boxSize && y >= this.boxY && y <= this.boxY + this.boxSize) {
            this.score++;
    ...
    countdown() {
        if (this.timeRemaining > 0) {
            this.timeRemaining--;
            document.getElementById('timeRemaining').innerText = "Time Remaining: " + this.timeRemaining + "s";
        } else {
